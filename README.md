...
A shoot management and folder generation platform for photographers, DITs, and studio managers. Automates folder creation, filename generation, and shot list production. Built with React, TypeScript, and Zustand.
...
- 15 years commercial photography - Nike, Ralph Lauren, Sephora, L'Oreal, David Yurman, Coach, Anthropologie, Vogue
- Digital Capture Technician and Digital Producer - Milk Studios (2010-2012)
- Digital Archivist - Richard Avedon Foundation, Contract (2013-2014)
- Digital Production Manager and Workflow Automation - Untitled NYC / Eileen Fisher, Contract (2024)
...
**Visual Forensics:** Synthetic media detection, deepfake identification, lighting and shadow analysis, image authentication, anomaly detection

**On set:** Capture One, Photoshop, ChronoSync, Eizo calibration, tethered capture, medium format film, RAID workflows
...
- CompTIA Security+ - Candidate (2026)
